package pages.InformationAboutStudent;

import java.time.LocalDate;
import java.time.Month;

public abstract class ProfileStudentConst {
    public final static String FNAME = "Александра";
    public final static String LNAME = "Куликова";
    public final static String  FNAME_LATIN = "Alexandra";
    public final static String LNAME_LATIN = "Kulikova";
